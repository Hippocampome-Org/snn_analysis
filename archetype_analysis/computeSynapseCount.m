...
% Change the names of the neuron types so that they match the syntax used
% in CARLsim.
...
% Compute the number of synapses for each synapse type.
...
% Write the number of synapses by synapse type back to the original XL.
