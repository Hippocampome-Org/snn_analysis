...
for i = 1:length(binnedSim2)
    ...
    % bounds
    [popActivity,summedPopActivity,summedPopActivityPyr,summedPopActivityIN, ...
     ...
     pop,giniNType] = computePopStats(binnedSim2{i},tf,totalBins,className{i},fileOutLoc);
    ...
    periMeanCVISI = corrcoef(cellMatMeanISI{1},cellMatCVISI{1});
    periMeanCVISI = periMeanCVISI(2,1);
    dendMeanCVISI = corrcoef(cellMatMeanISI{2},cellMatCVISI{2});
    dendMeanCVISI = dendMeanCVISI(2,1);
    pyrMeanCVISI = corrcoef(cellMatMeanISI{3},cellMatCVISI{3});
